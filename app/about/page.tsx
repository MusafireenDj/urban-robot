    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black">
      ...
      <section className="py-20 text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-5xl font-bold text-white mb-6">من نحن</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-orange-100 text-lg">رحلة نجاح بدأت من حلم بسيط لتصبح واقعاً يخدم المجتمع</p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open("https://wa.me/+25377777777?text=مرحباً، أريد معرفة المزيد عن خدماتكم", "_blank")
                    }
                  >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12">
              <Card className="hover:shadow-lg transition-shadow bg-gray-700 border-gray-600">
                <CardHeader className="text-center">
                  <div className="bg-orange-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                    <Award className="h-8 w-8 text-orange-600" />
                  </div>
                  <CardTitle className="text-2xl text-white">رؤيتنا</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="hover:shadow-lg transition-shadow bg-gray-700 border-gray-600">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-2xl text-white">مهمتنا</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300 text-center leading-relaxed">
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h3 className="text-3xl font-bold text-white mb-4">فريق العمل</h3>
      ...
      <section className="py-16 bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h3 className="text-3xl font-bold text-white mb-4">قيمنا</h3>
              <p className="text-gray-300 max-w-2xl mx-auto">المبادئ والقيم التي نؤمن بها وتوجه عملنا اليومي</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-white mb-2">المصداقية</h4>
                <p className="text-gray-300 text-sm">نلتزم بالصدق والشفافية في جميع تعاملاتنا</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-white mb-2">الجودة</h4>
                <p className="text-gray-300 text-sm">نسعى دائماً لتقديم أعلى مستويات الجودة</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-white mb-2">خدمة العملاء</h4>
                <p className="text-gray-300 text-sm">عملاؤنا هم محور اهتمامنا وأولويتنا الأولى</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-white mb-2">الالتزام</h4>
                <p className="text-gray-300 text-sm">نلتزم بمواعيدنا ووعودنا مع عملائنا</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-500 to-yellow-500 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-orange-100 text-lg mb-8">انضم إلى مئات العملاء الراضين واكتشف أفضل العقارات في جيبوتي</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                onClick={() =>
                  window.open("https://wa.me/+25377777777?text=مرحباً، أريد الاستفسار عن خدماتكم", "_blank")
                }
              >
                <MessageCircle className="ml-2 h-5 w-5" />
                تواصل معنا
