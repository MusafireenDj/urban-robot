...
import { MapPin, Phone, Mail, MessageCircle, Bed, Bath, Square, Star, Play, ExternalLink } from 'lucide-react'
import { useEffect, useState } from "react"
import { SiteSettings, defaultSettings, loadSettings } from "@/lib/settings"
...
export default function HomePage() {
  ...
  const openGoogleMaps = () => {
    const address = encodeURIComponent(settings.contactInfo.address)
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4 rtl:space-x-reverse">
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">{settings.siteDescription}</p>
              </div>
            </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src={settings.heroImage || "/placeholder.svg?height=1080&width=1920&text=منزل+في+جيبوتي"}
            alt="منزل في جيبوتي"
            fill
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-6xl md:text-7xl font-bold text-white mb-6 drop-shadow-2xl">
              {settings.heroTitle || "اعثر على منزلك في جيبوتي"}
            </h2>
            <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto drop-shadow-lg">
              {settings.heroSubtitle || "نوفر لك أفضل الشقق والمنازل للإيجار في أجمل مناطق جيبوتي بأسعار مناسبة وخدمة متميزة"}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(`https://wa.me/${settings.contactInfo.whatsapp.replace(/[^0-9]/g, '')}?text=مرحباً، أريد الاستفسار عن العقارات المتاحة`, "_blank")
                }
              >
                ...
                <CardContent>
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `https://wa.me/${settings.contactInfo.whatsapp.replace(/[^0-9]/g, '')}?text=مرحباً، أريد الاستفسار عن ${property.title}`,
                          "_blank",
                        )
                      }
                    >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="text-center hover:shadow-lg transition-shadow bg-gray-700 border-gray-600">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-300 mb-2">{settings.contactInfo.phone}</p>
                  <Button
                    className="mt-3 w-full bg-transparent"
                    variant="outline"
                    onClick={() => (window.location.href = `tel:${settings.contactInfo.phone}`)}
                  >
                    اتصال الآن
                  </Button>
                </CardContent>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow bg-gray-700 border-gray-600">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-300 mb-2">{settings.contactInfo.email}</p>
                  <Button
                    variant="outline"
                    className="w-full bg-transparent"
                    onClick={() => (window.location.href = `mailto:${settings.contactInfo.email}`)}
                  >
                    إرسال إيميل
                  </Button>
                </CardContent>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 rtl:space-x-reverse mb-4">
                ...
                <h4 className="text-xl font-bold">{settings.siteName}</h4>
              </div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 {settings.siteName}. جميع الحقوق محفوظة.</p>
          </div>
        </div>
      </footer>
    </div>
